...
// Optional: Vector store for conversation history
...
if (!PINECONE_API_KEY) warnMissing("PINECONE_API_KEY (vector store disabled)");
if (!PINECONE_INDEX_NAME) warnMissing("PINECONE_INDEX_NAME (vector store disabled)");

// Optional: User analytics and tracking
...
if (!SEGMENT_PROFILE_API_TOKEN) warnMissing("SEGMENT_PROFILE_API_TOKEN (user analytics disabled)");
if (!SEGMENT_TRACKING_WRITE_KEY) warnMissing("SEGMENT_TRACKING_WRITE_KEY (user analytics disabled)");
if (!SEGMENT_WORKSPACE_ID) warnMissing("SEGMENT_WORKSPACE_ID (user analytics disabled)");
if (!SEGMENT_SPACE_ID) warnMissing("SEGMENT_SPACE_ID (user analytics disabled)");
